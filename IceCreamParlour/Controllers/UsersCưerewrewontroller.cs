...
{
    public class UsersCưerewrewontroller : Controller
    {
        private DbIcecreamParlourEntities db = new DbIcecreamParlourEntities();

        // GET: UsersCưerewrewontroller
        public ActionResult Index()
        {
            return View(db.Users.ToList());
        }

        // GET: UsersCưerewrewontroller/Details/5
        ...
        // GET: UsersCưerewrewontroller/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: UsersCưerewrewontroller/Create
        ...
        // GET: UsersCưerewrewontroller/Edit/5
        ...
        // POST: UsersCưerewrewontroller/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: UsersCưerewrewontroller/Delete/5
        ...
        // POST: UsersCưerewrewontroller/Delete/5
